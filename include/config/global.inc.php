 ...
 */
$config['DEBUG'] = 0;
$config['SALT'] = 'ChangeThisRandomSalt1';
$config['SALTY'] = 'ChangeThisRandomSalt2';
...
$config['wallet']['host'] = 'localhost:9401';
$config['wallet']['username'] = 'YourUsername';
$config['wallet']['password'] = 'YourPassword';
 ...
 **/
$config['gettingstarted']['coinname'] = 'vDinar';
$config['gettingstarted']['coinurl'] = 'https://www.vdinar.info';
$config['gettingstarted']['stratumurl'] = 'svarog.jugoslaven.com';
...
$config['price']['url'] = 'https://voda.network';
$config['price']['target'] = '';
...
$config['memcache']['keyprefix'] = 'stratum_';
...
$config['cookie']['domain'] = 'svarog.jugoslaven.com';
$config['cookie']['path'] = '/';
